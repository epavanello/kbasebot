...
const LeadsSettings = () => {
  ...
  useEffect(() => {
    const getChatbotSettings = async () => {
      ...
      if (chatbotSettings?.leads) setLeadValues(chatbotSettings?.leads);
    };
      ...
      <CardContent className="flex flex-col gap-6">
        ...
        <div className="grid w-full gap-1.5">
          ...
          <Textarea
            ...
            value={leadValues.confirmation_message}
            placeholder="eg. Thanks for reaching out! Our team will get back to you soon"
          />
          <p className="text-sm text-muted-foreground">This message will be shown once user input the data</p>
        </div>
      </CardContent>
      <CardFooter>
        <Button onClick={saveLeadSettings}>Update</Button>
      </CardFooter>
    </Card>
  );
};
